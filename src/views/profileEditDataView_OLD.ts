...
//         childrens: {
//           Input: new Input({
//             attributes: profileEditFormData[0].input,
//             events: {
//               blur: function (this: Input, e) {
//                 e.preventDefault();
...
//         childrens: {
//           Input: new Input({
//             attributes: profileEditFormData[1].input,
//             events: {
//               blur: function (this: Input, e) {
//                 e.preventDefault();
...
//         childrens: {
//           Input: new Input({
//             attributes: profileEditFormData[2].input,
//             events: {
//               blur: function (this: Input, e) {
//                 e.preventDefault();
...
//         childrens: {
//           Input: new Input({
//             attributes: profileEditFormData[3].input,
//             events: {
//               blur: function (this: Input, e) {
//                 e.preventDefault();
//                 this.validate(Validator.validateUsername);
...
//         childrens: {
//           Input: new Input({
//             attributes: profileEditFormData[4].input,
//             events: {
//               blur: function (this: Input, e) {
//                 e.preventDefault();
//                 this.validate(Validator.validateUsername);
...
//         childrens: {
//           Input: new Input({
//             attributes: profileEditFormData[5].input,
//             events: {
//               blur: function (this: Input, e) {
//                 e.preventDefault();
...
//   }),
// ];
// export const dataForm = new Form({
//   events: {
